...
class LLMHandler:
    ...
    def initialize(
        ...
        try:
            ...
            # Allow env override to force eager mode (workaround for MIG GPU segfaults)
            if os.environ.get("ACESTEP_VLLM_ENFORCE_EAGER", "0") == "1":
                enforce_eager_for_vllm = True
                logger.info("ACESTEP_VLLM_ENFORCE_EAGER=1: forcing eager mode for vLLM")
